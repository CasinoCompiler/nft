...
contract MoodNft is ERC721{
    ...
    /** Constructor */
    constructor(string memory _name, string memory _symbol, string memory _happyImageUri,string memory _sadImageUri) ERC721 (_name, _symbol){
        s_tokenCounter = 0;
